...
func (c *userService) GetAll(ctx context.Context, in *User, opts ...client.CallOption) (*Response, error) {
...
func RegisterUserServiceHandler(s server.Server, hdlr UserServiceHandler, opts ...server.HandlerOption) error {
	type userService interface {
		...
		GetAll(ctx context.Context, in *User, out *Response) error
...
func (h *userServiceHandler) GetAll(ctx context.Context, in *User, out *Response) error {
