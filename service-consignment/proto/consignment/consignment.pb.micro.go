...
type ShippingService interface {
	...
	GetConsignments(ctx context.Context, in *Consignment, opts ...client.CallOption) (*Response, error)
}
...
func (c *shippingService) GetConsignments(ctx context.Context, in *Consignment, opts ...client.CallOption) (*Response, error) {
...
type ShippingServiceHandler interface {
	...
	GetConsignments(context.Context, *Consignment, *Response) error
}
...
func RegisterShippingServiceHandler(s server.Server, hdlr ShippingServiceHandler, opts ...server.HandlerOption) error {
	type shippingService interface {
		...
		GetConsignments(ctx context.Context, in *Consignment, out *Response) error
	}
	type ShippingService struct {
		shippingService
	}
...
func (h *shippingServiceHandler) GetConsignments(ctx context.Context, in *Consignment, out *Response) error {
